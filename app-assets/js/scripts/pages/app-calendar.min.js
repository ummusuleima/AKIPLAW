...
"rtl" == $("html").data("textdirection") && (direction = "rtl"),
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    if (f.length) {
      function x(e) {
        return e.id
          ? "<div class='d-flex flex-wrap align-items-center'><div class='avatar avatar-sm my-0 mr-50'><span class='avatar-content'><img src='" +
              assetPath +
              "images/avatars/" +
