    ...
    var o = e.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          checkboxes: {
            selectAllRender:
              '<div class="custom-control custom-checkbox"> <input class="custom-control-input" type="checkbox" value="" id="checkboxSelectAll" /><label class="custom-control-label" for="checkboaxSelectAll"></label></div>',
          },
        },
        { targets: 2, visible: !1 },
        {
      ...
      buttons: [
        ...
        },
        {
            ...
            attr: { "data-toggle": "modal", "data-target": "#create-new-billing" },
            init: function (e, a, t) {
              $(a).removeClass("btn-secondary");
            },
          },
